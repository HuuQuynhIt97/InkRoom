            ...
            modelBuilder.Entity("INK_API.Models.BPFCEstablish", b =>
                {
                    b.HasOne("INK_API.Models.ArtProcess", "ArtProcess")
                        ...
                        .HasForeignKey("INK_API.Models.BPFCEstablish", "ArtProcessID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("INK_API.Models.ArticleNo", "ArticleNo")
                        .WithOne("BPFCEstablish")
                        .HasForeignKey("INK_API.Models.BPFCEstablish", "ArticleNoID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("INK_API.Models.ModelName", "ModelName")
                        .WithOne("BPFCEstablish")
                        .HasForeignKey("INK_API.Models.BPFCEstablish", "ModelNameID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("INK_API.Models.ModelNo", "ModelNo")
                        .WithOne("BPFCEstablish")
                        .HasForeignKey("INK_API.Models.BPFCEstablish", "ModelNoID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
