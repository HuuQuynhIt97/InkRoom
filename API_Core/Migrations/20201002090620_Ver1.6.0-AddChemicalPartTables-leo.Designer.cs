...
namespace INK_API.Migrations
{
    ...
    [Migration("20201002090620_Ver1.6.0-AddChemicalPartTables-leo")]
    partial class Ver160AddChemicalPartTablesleo
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("INK_API.Models.Part", b =>
                {
                    ...
                    b.Property<int?>("SchedulesUpdatesID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("INK_API.Models.Part", b =>
                {
                    b.HasOne("INK_API.Models.SchedulesUpdate", "SchedulesUpdates")
                        .WithMany("Parts")
                        .HasForeignKey("SchedulesUpdatesID");
                });
