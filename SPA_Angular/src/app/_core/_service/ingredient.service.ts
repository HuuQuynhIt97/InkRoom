...
export class IngredientService {
  ...
  getAllSupplierWithName() {
    return this.http.get<ISupplier[]>(this.baseUrl + 'Suppier/GetAllWithName', {});
  }

  getAllSupplierByTreatment(id) {
    return this.http.get<ISupplier[]>(this.baseUrl + `Suppier/GetAllByTreatment/${id}`, {});
  }
